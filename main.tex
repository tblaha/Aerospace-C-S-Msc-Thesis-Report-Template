...
% 1. inside margin is 8mm larger than the outside margin to take into account the glue bind (total textwidth stays the same)
% 2. Front matter contains empty pages if necessary to put titlepage/preface/toc and introduction on right-hand (odd) pages. All other chapters remain unaffected
% 3. new Parts start on right-hand (odd) pages. All remaining Chapters/Sections are unaffected
% 4. Scientific article starts on an odd page, so page numbers remain odd-right
%
